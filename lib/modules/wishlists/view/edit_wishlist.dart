...
class EditWishListData extends StatelessWidget {
  const EditWishListData({super.key});
                          ...
                          Center(
                            child: CommonElevatedButton(
                              ...
                              onTap: () async {
                                ...
                                if (isValid) {
                                 await controller.updateWishListDetails();
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomizedTextWidget(
                      ...
                      textValue: "Are you sure want to delete this wish.If this wish is already fulfilled then you can't delete",
                      fontFamily: 'Poppins-Bold',
                    ),
                  ),
                  Divider(
