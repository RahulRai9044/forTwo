...
class _LoginScreenState extends State<GoogleLoginScreen>{
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  InkWell(
                                                ...
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    image: DecorationImage(
                                                        image:
                                                        AssetImage("assets/icons/google_icon_img.png"),
                                                        fit: BoxFit.cover),
                                    ...
                                    onTap: ()
                                    async{
                                      signInWithGoogle(controller);
                                        //   .then((User user){
                                        // controller.clearAllModels();
